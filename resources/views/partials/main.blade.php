			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					...
					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="../../../../global_assets/images/flags/de.png" alt=""> Luganda</a></li>
						<li><a class="ukrainian"><img src="../../../../global_assets/images/flags/ua.png" alt=""> Rukiga</a></li>
						<li><a class="english"><img src="../../../../globalassets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="../../../../global_assets/images/flags/es.png" alt=""> Rutooro</a></li>
						<li><a class="russian"><img src="../../../../global_assets/images/flags/ru.png" alt=""> Lusoga</a></li>
					</ul>
				</li>
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						...
						<img src="assets/images/uganda.png" alt="">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="#"><i class="icon-coins"></i> My Taxes</a></li>
						<li><a href="#"><span class="badge bg-teal-400 pull-right">58</span> <i class="icon-comment-discussion"></i> Messages</a></li>
						<li class="divider"></li>
						<li><a href="#"><i class="icon-cog5"></i> Account settings</a></li>
						<li><a class="icon-switch2" href="{{ route('logout') }}"
	...
	<div class="page-container">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<a href="#" class="media-left"><img src="assets/images/uganda.png" class="img-circle img-sm" alt=""></a>
								<div class="media-body">
									<span class="media-heading text-semibold">PTAX-MIS</span>
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> &nbsp;Kampala, UG
									</div>
								</div>
					...
					<div class="page-header-content">
						...
						<div class="heading-elements">
							<div class="heading-btn-group">
								...
								<a href="#" class="btn btn-link btn-float has-text"><i class="icon-calculator text-primary"></i> <span>Tax Reports</span></a>
								<a href="#" class="btn btn-link btn-float has-text"><i class="icon-calendar5 text-primary"></i> <span>Payments</span></a>
							</div>
						</div>
					</div>
        ...
        <!-- Footer -->
                <div class="footer text-muted">
                  &nbsp &copy; 2015. <a href="#"> Property Tax Management System </a> by <a href="#" target="_blank">Bugema #DevTeam</a>
                </div>
                <!-- /footer -->
